...
//java.sql 패키지에 존재합니다.
//!)java.sql은 대부분 추상클래스와 Interface로 구성되어 있고, 
...
//3.질의문(SQL)을 날린다.
//4.3의 결과를 가공한다.
//5.2번에서 한 Connection을 닫는다.

public class DBcontrolEx {

	public static void main(String args[]) throws Exception{
		//1.맨더(mysql)의 jdbc driver(connector/j)를 로딩한다.
		...
		//http://naver.com -> 주소
		//DBConnection을 얻으려면 Host, id, password, port정보
...
//		sql = "insert into test_table(user_no,user_name)values('10','이종석')";
	...
	//pstmt2 = conn.prepareStatement(sql);
		...
		//Delete
		//PreparedStatement pstmt3로 user_name='AAA'인것만 삭제하라
